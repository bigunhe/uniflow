  ...
  async function sendMessage() {
    ...
    try {
      ...
      setConversations((prev) => {
        ...
        return {
          ...prev,
          [selectedMentor.id]: [...withoutOptimistic, mapDbMessageToChat(payload.message)],
        };
      });
    } catch {
      ...
      <header className="sticky top-0 z-40 border-b border-slate-200 bg-white">
        <div className="mx-auto flex h-14 max-w-7xl items-center justify-between gap-4 px-4">
          ...
          <nav className="hidden items-center gap-7 text-sm font-semibold text-slate-700 md:flex">
            ...
            <a className="hover:text-indigo-700" href="/networking/mentors">
              Mentors
            </a>
            <a className="hover:text-indigo-700" href="/networking">
              Resources
            </a>
            <a className="hover:text-indigo-700" href="#">
              Community
