    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="grid grid-cols-1 md:grid-cols-2 min-h-screen">
        ...
        <div className="bg-gradient-to-br from-[#4747EB] via-[#7B67D1] to-[#B85393] text-white p-8 md:p-12 flex flex-col justify-between">
          <div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4 items-start">
                <div className="w-10 h-10 bg-green-400 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  <CheckCircle size={24} className="text-white" />
                </div>
                <div>
                  <p className="font-semibold text-lg">Your Progress</p>
                  <p className="text-green-100">Track your learning with personalized dashboards</p>
                </div>
              </div>
              <div className="flex gap-4 items-start">
                <div className="w-10 h-10 bg-green-400 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                ...
                <div>
                  ...
                  <p className="text-green-100">Direct access to your assigned mentors</p>
                </div>
              </div>
              <div className="flex gap-4 items-start">
                <div className="w-10 h-10 bg-green-400 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                ...
                <div>
                  ...
                  <p className="text-green-100">Access curated learning materials & projects</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Footer Text */}
          <p className="text-green-100 text-sm">© 2024 uniflow. Empowering the next generation of IT professionals.</p>
        </div>
        ...
        <div className="flex items-center justify-center p-6 md:p-12">
          <div className="w-full max-w-md">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition bg-gray-50"
                    required
                  />
                </div>
              </div>
            ...
            <p className="mt-6 text-center text-gray-600">
              ...
              <Link href={userType === 'student' ? '/student/register' : '/mentor/register'} className="text-green-600 hover:text-green-700 font-semibold">
                Sign up
              </Link>
            </p>
          </div>
