    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .root p,.root span,.root label,.root li,.root strong{color:#4d648e !important;}
        ...
        .back-btn{display:flex;align-items:center;gap:8px;padding:9px 16px;border-radius:10px;background:rgba(255,255,255,.76);border:1px solid rgba(67,96,151,.25);color:#2d4671 !important;font-family:'DM Sans',sans-serif;font-size:13px;cursor:pointer;transition:all .18s;}
        .back-btn:hover{background:#ffffff;color:#1a2f56 !important;}
        .page-title{font-family:'Syne',sans-serif;font-size:18px;font-weight:700;color:#17233a !important;}
        ...
        .step-name{font-size:11px;color:#5f769b !important;font-weight:600;letter-spacing:.04em;}
        .step-circle.active~.step-name,.step-circle.done~.step-name{color:#3f5784 !important;}
        ...
        .card-sub{font-size:14px;color:#6078a1 !important;line-height:1.6;}
        ...
        .module-title{font-size:14px;font-weight:600;color:#2a426d !important;line-height:1.4;}
        ...
        .field input, .field textarea{width:100%;padding:13px 16px;background:rgba(255,255,255,.96);border:1px solid rgba(67,96,151,.24);border-radius:12px;font-family:'DM Sans',sans-serif;font-size:15px;color:#1b2f55;outline:none;transition:border-color .2s,background .2s;resize:vertical;}
        .field input:focus,.field textarea:focus{border-color:rgba(63,92,255,.45);background:#fff;}
        .field input::placeholder,.field textarea::placeholder{color:#6a7fa2;}
        .field-hint{font-size:12px;color:#61789f !important;margin-top:6px;}
        .char-count{font-size:11px;color:#61789f !important;text-align:right;margin-top:4px;}
        ...
        .upload-label{font-size:13px;color:#516990 !important;text-align:center;}
        .upload-label strong{color:rgba(0,210,180,.7);}
        .upload-sub{font-size:11px;color:#6b7fa2 !important;}
        ...
        .btn-back{padding:13px 22px;border-radius:12px;background:rgba(67,96,151,.08);border:1px solid rgba(67,96,151,.2);font-family:'DM Sans',sans-serif;font-size:14px;font-weight:600;color:#2d4671 !important;cursor:pointer;transition:all .18s;}
        .btn-back:hover{background:rgba(67,96,151,.14);color:#1a2f56 !important;}
        ...
        .summary-text{font-size:13px;color:#4d648e !important;line-height:1.5;}
        .summary-text strong{color:#17233a !important;}
